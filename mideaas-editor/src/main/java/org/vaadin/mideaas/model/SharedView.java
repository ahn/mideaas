...
//	private final String modelId = generateModelId();
	...
	public SharedView(String javaPackage, String name, File saveBaseToDir, ProjectLog log) {
		...
		controllerMud = new MultiUserDoc(codeFile.getName(), new AceDoc(code), javaChecker, codeFile, log);
		...
		modelMud = new MultiUserDoc(modelFile.getName(), new AceDoc(xml), new XmlSyntaxErrorChecker(), modelFile, log);
