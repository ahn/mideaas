...
import org.vaadin.mideaas.model.MultiUserDoc.BaseChangedListener;
...
public class ClaraEditor extends CustomComponent implements
	...
	public ClaraEditor(User user, MultiUserDoc modelMud) {
		...
		this.user = user;
		mud = modelMud;
		editor = new MultiUserEditor(user, mud);
	...
	public void attach() {
		...
		mud.addBaseChangedListener(this);
	...
	public void setXml(String xml) {
		mud.getUserDoc(user).setValue(new AceDoc(xml), true);
	}
