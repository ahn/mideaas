...
public class Icons {
	...
	public static final ThemeResource DOCUMENT_VALID = TICK_CIRCLE;
	public static final ThemeResource DOCUMENT_ERRORS_NOT_BY_ME = NOTE;
	public static final ThemeResource DOCUMENT_ERRORS_BY_ME = CROSS_CIRCLE;
